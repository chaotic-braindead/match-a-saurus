                            ...
                            return Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      index != 10 ? _scores[index].player.name : "You",
                                      style:  TextStyle(
                                        fontSize: index != 10 ? SizeConfig.fontSize * 2.35 : SizeConfig.fontSize * 2.75,
                                        fontFamily: 'MadimiOne',
                                        fontWeight: index != 10 ? FontWeight.normal : FontWeight.bold,
                                        color: const Color.fromRGBO(36, 107, 34, 1),
                                      ),
                                      ),
                                    Text(
                                      _scores[index].player.score.toString(),
                                      style:  TextStyle(
                                        fontSize: index != 10 ? SizeConfig.fontSize * 2.35 : SizeConfig.fontSize * 2.75,
                                        fontFamily: 'MadimiOne',
                                        fontWeight: index != 10 ? FontWeight.normal : FontWeight.bold,
                                        color: const Color.fromRGBO(148, 126, 109, 1),
                                      ),
                                      )
                                  ],
                                ), (index == 9 && widget.score == -1) || index == 10 ? 
                                Container(
                                  margin: const EdgeInsets.only(top: 20),
                                  decoration: const BoxDecoration(
                                    border: Border(
                                      top: BorderSide(width: 5.0, color: Color.fromRGBO(
                                                  69, 141, 67, 1))
                                    )
                                  ),
                                  child: Padding(
